...
import { incidentService } from '../../backend/src/modules/incidents/incident.service.js';
import {
  createIncidentSchema,
  updateIncidentStatusSchema,
} from '../../backend/src/modules/incidents/incident.validator.js';
...
describe('Incident Lifecycle & Verification Tests', () => {
  ...
  describe('Incident Service & State Machine', () => {
    ...
    it('transitions incident status through valid state machine path', async () => {
      ...
      // Verify incident
      const verified = await incidentService.verifyIncident(created.id, {
    ...
    it('rejects invalid state machine transitions', async () => {
      ...
      // Attempt invalid transition: reported -> arrived (skipping dispatch)
      await expect(
